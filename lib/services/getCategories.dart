...
Future<List<ProductExample01>> getCategories()async{
  ...
  if(resp.statusCode == 200){
    List<ProductExample01> products =(json.decode(resp.body) as List).map((data) => ProductExample01.fromJson(data)).toList();
  return products;
  }else{
