 ...
 *
 * Locales: 2
 * Strings: 2 (1.0 per locale)
 *
 * Built on 2022-02-15 at 16:27 UTC
 */
...
late _StringVi _translationsVi = _StringVi.build();
...
extension AppLocaleExtensions on AppLocale {
	...
	_StringEn build() {
		switch (this) {
			case AppLocale.en: return _StringEn.build();
			case AppLocale.vi: return _StringVi.build();
		}
	}
...
class _StringEn {
	...
	// Translations
	String get name => 'pham tien dasssst';
}

// Path: <root>
class _StringVi implements _StringEn {
	...
	// ignore: unused_field
	@override late final _StringVi _root = this;

	// Translations
	@override String get name => 'pham tien dat';
}
...
extension on _StringEn {
	Map<String, dynamic> _buildFlatMap() {
		return {
			'name': 'pham tien dasssst',
		};
	}
}

extension on _StringVi {
	Map<String, dynamic> _buildFlatMap() {
		return {
			'name': 'pham tien dat',
		};
